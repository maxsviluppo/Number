...
export const BADGES: Badge[] = [
    ...
    { id: 'boss_1_defeated', title: 'Sterminatore Matematico', description: 'Sconfiggi il primo Boss: Il Boss Matematico.', icon: Swords, color: 'text-emerald-400', bgGradient: 'from-emerald-900/40 to-black/40', condition: (s) => false }, // Condition is manual sync
