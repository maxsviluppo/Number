                ...
                <div className="relative z-10 flex-1 overflow-y-auto px-6 pb-6 custom-scroll">
                    ...
                    {activeTab === 'profile' && (
                        <div className="space-y-4 animate-fadeIn">
                            ...
                            <button
                                onClick={() => window.open('https://numbergame.it/privacy.html', '_blank')}
                                className="mt-4 w-full p-4 bg-slate-800/50 hover:bg-slate-700/50 rounded-2xl border border-slate-700 flex items-center justify-between transition-all group"
                            >
                                <div className="flex items-center gap-3">
                                    <div className="p-2 bg-slate-900 rounded-xl group-hover:scale-110 transition-transform">
                                        <Shield size={20} className="text-slate-400 group-hover:text-white transition-colors" />
                                    </div>
                                    <div className="text-left">
                                        <h3 className="text-white font-bold text-sm uppercase tracking-wide">Privacy & Policy</h3>
                                        <p className="text-slate-500 text-[10px] uppercase">Leggi le norme sulla privacy e i termini</p>
                                    </div>
                                </div>
