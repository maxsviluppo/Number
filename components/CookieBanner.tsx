...
import { ShieldCheck, CheckSquare, Settings } from 'lucide-react';
      ...
      <div className="glass-panel border border-white/10 rounded-[2rem] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.8)] relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-['Orbitron'] font-black text-white text-lg tracking-wider">{t('cookie.title')}</h2>
          </div>
            ...
            <>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <Settings className="w-3 h-3" /> {t('cookie.settings')}
                  </button>
                  <button
            ...
            <>
              <div className="space-y-4 mb-8">
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-xl border border-white/5">
                  <span className="text-xs font-bold text-white tracking-widest uppercase">{t('cookie.necessary')}</span>
                ...
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-xl border border-white/5 opacity-60">
                  <span className="text-xs font-bold text-white tracking-widest uppercase">{t('cookie.marketing')}</span>
          ...
          <div className="mt-6 pt-6 border-t border-white/5 flex justify-center gap-4 text-[10px] uppercase font-black tracking-widest text-[#FF8800]/60">
            <Link to="/privacy" className="hover:text-[#FF8800]">{t('cookie.privacyPolicy')}</Link>
            <Link to="/cookies" className="hover:text-[#FF8800]">{t('cookie.cookiePolicy')}</Link>
          </div>
        </div>
      </div>
    </div>
